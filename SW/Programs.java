...
public class Programs {
    ...
    public Word[] fatorialV2 = new Word[] {
    ...
    public Word[] fibonacci10v2 = new Word[] {
          new Word(Opcode.LDI, 1, -1, 0),
          new Word(Opcode.STD, 1, -1, 20),
          new Word(Opcode.LDI, 2, -1, 1),
          new Word(Opcode.STD, 2, -1, 21),
        ...
        public Word[] fibonacciREAD = new Word[] { // mesmo que prog exemplo, so que usa r0 no lugar de r8
